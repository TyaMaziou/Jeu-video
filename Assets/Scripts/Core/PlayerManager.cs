   ...
   public void AddDeath()
{
    ...
    // [ADDED] Réinitialisation du compteur de morts si le joueur meurt 3 fois
    if (nbDeath >= 3)
    {
        nbDeath = 0;
    }

    // [ADDED] Si nbDeath est égal à zéro, charge la scène du menu
    if (nbDeath == 0)
    {
        SceneManager.LoadScene("TitleMenu"); // Remplacez "MenuScene" par le nom de votre scène de menu
    }
}
